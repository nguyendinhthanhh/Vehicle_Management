...
public class Vehicle implements Serializable{
    ...
    public String toString() {
        return "Vehicle |" + "ID_Vehicle=" + ID_Vehicle + " | Name_Vehicle=" + Name_Vehicle + " | color_Vehicle=" + color_Vehicle + " | price_Vehicle=" + price_Vehicle + " | brand_Vehicle=" + brand_Vehicle + " | type=" + type + " | productYear=" + productYear + '|';
    }
